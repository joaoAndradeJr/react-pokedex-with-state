...
- Use o comando: `git clone git@github.com:tryber/sd-000-exercise-pokedex-state-2023-05-05-09-07-37`.
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b joaozinho-sd-000-exercise-pokedex-state-2023-05-05-09-07-37`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-000-exercise-pokedex-state-2023-05-05-09-07-37`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-000-exercise-pokedex-state-2023-05-05-09-07-37/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-000-exercise-pokedex-state-2023-05-05-09-07-37/pulls) e confira que o seu _Pull Request_ está criado
...
- Vá até a página **DO SEU** _Pull Request_, adicione a label de _"code-review"_ e marque seus colegas:
  ...
  - No menu à direita, clique no _link_ **"Reviewers"** e digite `students`, selecione o time `tryber/students-sd-000`.
...
<details>
  ...
  [FORMULÁRIO DE AVALIAÇÃO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH00&template=betrybe/sd-0x-exercise-pokedex-state)
